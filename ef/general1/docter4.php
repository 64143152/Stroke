...
<input type="button" class="5" value="5. กำลังของกล้ามเนื้อแขน (Motor Arm)">
<center>_______________________________________________________________ </center>

<input type="button" class="6" value="6. การประสานงานของแขนขา (Limb Ataxia)">
<center>_______________________________________________________________ </center>

<input type="button" class="7" value="7. การมองเห็น (Visual Fields)">
<center>_______________________________________________________________ </center>

<input type="button" class="8" value="8. การรับความรู้สึก (Sensory)">
<center>_______________________________________________________________ </center>

<input type="button" class="9" value="9. ความสามารถด้านภาษา (Best Language)">
<center>_______________________________________________________________ </center>

<input type="button" class="10" value="10. การออกเสียง (Dysarthria)">
<center>_______________________________________________________________ </center>

<input type="button" class="11" value="11. การขาดความสนใจในด้านใดด้านหนึ่งของร่างกาย (Extinction and Inattention)">
<center>_______________________________________________________________ </center>
<a href="12.php">
<input type="button" class="12" value="สรุปคะแนน"> 
</a>
<br>
<br><br><br>
