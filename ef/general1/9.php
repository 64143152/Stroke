...
<ul class="choice11">
    <li>
        <input type="button" class="10" onclick="changeBackgroundColor11(event, 'lightblue', 0, 'score11')" value=" 0 = การสื่อภาษาเป็นปกติ">
    </li>
    <li>
        <input type="button" class="10" onclick="changeBackgroundColor11(event, 'lightblue', 1, 'score11')" 
    ...
    <li>
        <input type="button" class="10" onclick="changeBackgroundColor11(event, 'lightblue', 2, 'score11')" 
    ...
    <li>
        <input type="button" class="10" onclick="changeBackgroundColor11(event, 'lightblue', 3, 'score11')" 
