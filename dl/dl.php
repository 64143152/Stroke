...
<body>
    ...
    <section class="hero">
        <div class="container">
            <div class="hero-con">
                <div class="hero-info">
                    <h5>Stroke Fighter แอปพลิเคชันป้องกันและดูแลรักษาโรคหลอดเลือดสมองครบวงจร (Comprehensive Stroke Prevention And Treatment Application)
                    </h5>
                    <a href="https://play.google.com/store/games?device=windows&utm_source=apac_med&hl=en-TH&utm_medium=hasem&utm_content=Jan0324&utm_campaign=Evergreen&pcampaignid=MKT-EDR-apac-th-1707570-med-hasem-py-Evergreen-Jan0324-Text_Search_BKWS-BKWS%7CONSEM_kwid_43700035223736020_creativeid_406968768419_device_c&gad_source=1&gclid=Cj0KCQjwvb-zBhCmARIsAAfUI2uEc00Z9dJhv8vGBEiEOH9FRc1TL7sYd20wwNbjhzsnaMeDOTyDFdwaAgN_EALw_wcB&gclsrc=aw.ds&pli=1" target="_black"><img src="images\download.png" alt=""></a>
                </div>
